...
class TimetableWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
        ...
        try {
            ...
            var nowDayTimetable = jsonData.getJSONArray(weekEvenOdd).getJSONArray(dateDayOfWeek)
            var nowWeekEvenOdd = weekEvenOdd
            var nowDateWeekDay = dateDayOfWeek
            var nowDaysCount = 0
            ...
            var thenDayTimetable = jsonData.getJSONArray(weekEvenOdd).getJSONArray(dateDayOfWeek)
            var thenWeekEvenOdd = weekEvenOdd
            var thenDateWeekDay = dateDayOfWeek
            var thenDaysCount = 0
